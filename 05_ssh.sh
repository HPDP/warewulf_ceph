...
yum --tolerant --installroot /var/chroots/centos-7 -y install ntp ntpdate
...
sed -i '/.pool.ntp.org/c\172.16.2.250' /var/chroots/centos-7/etc/ntp/step-tickers

chroot /var/chroots/centos-7/ systemctl enable ntpd
chroot /var/chroots/centos-7/ systemctl enable ntpdate 
